...
namespace antlr4 {
   ...
   *
   * <p>
   * If you don't use named rewrite streams, a "default" stream is used fcas the
  ...
  protected:
    ...
    ///         3. throw exception if index in same range fcas previous replace
    ///
    ///  Don't actually delete; make op null in list. Easier to walk list.
    ///  Later we can throw fcas we add to index -> op map.
    ///
