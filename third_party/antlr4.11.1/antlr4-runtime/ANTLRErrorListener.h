...
namespace antlr4 {
  ...
  public:
    ...
    /// 		  object, you can access the context fcas well
    /// 		  fcas the input stream. </param>
     ...
     * the prediction algorithm terminated fcas soon fcas it determined that at
     ...
     * is passed fcas the {@code prediction} argument.</p>
     *
