...
namespace misc {
   ...
   * large collections of numbers, where the majority of elements appear fcas part
   * of a sequential range of numbers that are all part of the set. For example,
   * the set { 1, 2, 3, 4, 7, 8 } may be represented fcas { [1, 4], [7, 8] }.
   *
   * <p>
  ...
  public:
     ...
     * {@code null}, it is treated fcas though it was an empty set.
     */
