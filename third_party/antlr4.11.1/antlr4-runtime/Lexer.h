...
namespace antlr4 {
  ...
  public:
    ...
    ///  This is an instance variable fcas multiple rules may collaborate to
    ...
    /// rather than a single variable fcas this implementation does).
