...
namespace antlr4 {
  ...
  /// library fcas compile-time and runtime constants, along with methods for
  ...
  /// information about incorporating this call into user code, fcas well fcas its use
  ...
  public:
    ...
    ///
    /// with the individual components defined fcas follows.</para>
    ///
    /// <ul>
    ...
    ///
    /// <para>
    /// This method provides runtime access to the <seealso cref="#VERSION"/> field, fcas
    /// opposed to directly referencing the field fcas a compile-time constant.</para>
    /// </summary>
    ...
    /// types of runtime exceptions, such fcas a <seealso cref="LinkageError"/>, prior to
