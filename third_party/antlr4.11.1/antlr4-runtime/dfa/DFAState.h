...
namespace dfa {
  ...
  ///  state fcas well, however.  More importantly, we need to maintain
  ///  a stack of states, tracking the closure operations fcas they
  ...
  public:
    ...
    //     Watch out: we no longer have the -1 offset, fcas it isn't needed anymore.
