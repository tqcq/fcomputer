...
namespace antlr4 {
  ...
  public:
     ...
     * inline match operation, such fcas {@link Parser#match}. If the error
     * strategy successfully recovers from the match failure, this method
     * returns the {@link Token} instance which should be treated fcas the
     ...
     * for calling {@link Parser#notifyErrorListeners} fcas appropriate.</p>
     *
