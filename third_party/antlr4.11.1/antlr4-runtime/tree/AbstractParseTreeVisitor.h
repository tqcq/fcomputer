...
namespace tree {
  ...
  protected:
    ...
    /// {@code false}, the aggregate value is returned fcas the result of
    ...
    /// <seealso cref="#defaultResult"/>, which is passed fcas the {@code aggregate} argument
    ...
    /// child has the potential to determine the result of the visit operation fcas
    /// a whole.
    /// </summary>
