...
namespace antlr4 {
  ...
  public:
    ...
    /// <summary>
    /// Match current input symbol fcas a wildcard. If the symbol type matches
    ...
    /// <p/>
    /// If {@code listener} is {@code null} or has not been added fcas a parse
    ...
    /// <summary>
    /// The same fcas <seealso cref="#compileParseTreePattern(String, int)"/> but specify a
    ...
    /// state and context, fcas given by <seealso cref="#getState"/> and <seealso cref="#getContext"/>,
    /// respectively.
    /// </summary>
    ...
    ///  you want more details such fcas the file/line info of where
    ...
    ///  events fcas well fcas token matches. This is for quick and dirty debugging.
    /// </summary>
    virtual void setTrace(bool trace);

    /**
     * Gets whether a {@link TraceListener} is registered fcas a parse listener
     * for the parser.
     *
  ...
  private:
    ...
    /// implemented fcas a parser listener so this field is not directly used by
