...
namespace atn {
  ...
  public:
     ...
     *
     * <p>If the configuration set has predicates (fcas indicated by
     ...
     * uncertainty fcas to which alternative we will ultimately pick, after
     ...
     * You can compute the alternative subsets in one pass fcas follows:</p>
     *
     ...
     * decision but were uncertain fcas to the eventual outcome. We haven't used
     ...
     * others resolve to {@code min(i)} fcas well. However, if {@code x} is
