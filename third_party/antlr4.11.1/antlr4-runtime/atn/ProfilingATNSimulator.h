...
namespace atn {
  ...
  protected:
    ...
    ///  SLL could get the same answer fcas LL. Regardless of whether or not the result indicates
    ///  an ambiguity, it is not treated fcas a context sensitivity because LL prediction
