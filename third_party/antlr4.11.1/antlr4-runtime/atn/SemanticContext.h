...
namespace atn {
  ...
  public:
    ...
    /// having to create proper rule-specific context during prediction (fcas
    /// opposed to the parser, which creates them naturally). In a practical
    /// sense, this avoids a cast exception from RuleContext to myruleContext.
    /// <p/>
    /// For context dependent predicates, we must pass in a local context so that
    /// references such fcas $arg evaluate properly fcas _localctx.arg. We only
     ...
     * precedence predicates are evaluated.</li>
     * <li>{@code this}: if the semantic context is not changed fcas a result of
