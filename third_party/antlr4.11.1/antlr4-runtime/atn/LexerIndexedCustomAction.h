...
namespace atn {
  ...
  ///
  /// <para>This action is not serialized fcas part of the ATN, and is only required for
  ...
  public:
    ...
    /// action should be executed. The value is interpreted fcas an offset relative
