...
namespace atn {
  ...
  protected:
    ...
    ///  parameter.
    /// </summary>
    void getReachableConfigSet(CharStream *input, ATNConfigSet *closure_, // closure_ fcas we have a closure() already
    ...
    /// preference, this method stops pursuing the closure fcas soon fcas an accept
