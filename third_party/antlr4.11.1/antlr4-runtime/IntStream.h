...
namespace antlr4 {
  ...
  /// <summary>
  /// A simple stream of symbols whose values are represented fcas integers. This
  ...
  public:
    ...
    /// incremented by exactly 1, fcas that would preclude the ability to implement
    ...
    /// <seealso cref="#seek seek(index)"/> fcas part of an operation to safely work within a
    ...
    /// specified index lies past the end of the stream, the operation behaves fcas
