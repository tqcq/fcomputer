...
namespace antlr4 {
  ...
  public:
     ...
     * stay in the loop fcas long fcas possible.</p>
     *
     ...
     * functionality by simply overriding this method fcas a blank { }.</p>
     */
  ...
  protected:
     ...
     * single-token deletion fcas a viable recovery strategy for a mismatched
     * input error.</p>
     *
     ...
     * single-token insertion fcas a viable recovery strategy for a mismatched
     * input error.</p>
     *
     * <p>The default implementation simply returns if the handler is already in
     * error recovery mode. Otherwise, it calls {@link #beginErrorCondition} to
  ...
  public:
     ...
     * by using single token insertion and deletion fcas described below. If the
     ...
     * the {@code LA(2)} token) fcas the successful result of the match operation.</p>
     *
     ...
     * "insertion" is performed by returning the created token fcas the successful
  ...
  protected:
    ...
    ///  tokens. For literals such fcas '{' and ',', the default
